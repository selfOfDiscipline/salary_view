        ...
        <BoxCard title="社保信息" class="modelbox" :canedit="isDisable">
            <el-form 
                ...
                <el-form-item label="医疗工伤生育基数" prop="yilGongsShengyBaseMoney">
                    <el-input v-model="form.yilGongsShengyBaseMoney" placeholder="请输入" :disabled="isDisable"></el-input>
                </el-form-item>
                <el-form-item label="医疗个人系数" prop="yilPersonRatio">
                    <currency-input v-model="form.yilPersonRatio" placeholder="请输入" :disabled="isDisable"></currency-input>
                </el-form-item>
                ...
                <el-form-item label="医疗个人另缴金额" prop="yilPersonAddMoney">
                    <el-input v-model="form.yilPersonAddMoney" placeholder="请输入" :disabled="isDisable"></el-input>
                </el-form-item>
                <el-form-item label="工伤个人系数" prop="gongsPersonRatio">
                    <currency-input v-model="form.gongsPersonRatio" placeholder="请输入" :disabled="isDisable"></currency-input>
                </el-form-item>
                <el-form-item label="工伤公司系数" prop="gongsCompanyRatio">
                    <currency-input v-model="form.gongsCompanyRatio" placeholder="请输入" :disabled="isDisable"></currency-input>
                </el-form-item>
                <el-form-item label="生育个人系数" prop="shengyPersonRatio">
                    <currency-input v-model="form.shengyPersonRatio" placeholder="请输入" :disabled="isDisable"></currency-input>
                </el-form-item>
                <el-form-item label="生育公司系数" prop="shengyCompanyRatio">
                    <currency-input v-model="form.shengyCompanyRatio" placeholder="请输入" :disabled="isDisable"></currency-input>
                </el-form-item>

                <el-form-item label="养老失业基数" prop="yanglShiyBaseMoney">
                    <el-input v-model="form.yanglShiyBaseMoney" placeholder="请输入" :disabled="isDisable"></el-input>
                </el-form-item>
                <el-form-item label="养老个人系数" prop="yanglPersonRatio">
                    <currency-input v-model="form.yanglPersonRatio" placeholder="请输入" :disabled="isDisable"></currency-input>
                </el-form-item>
                ...
                <el-form-item label="失业个人系数" prop="shiyPersonRatio">
                    <currency-input v-model="form.shiyPersonRatio" placeholder="请输入" :disabled="isDisable"></currency-input>
                </el-form-item>
                <el-form-item label="失业公司系数" prop="shiyCompanyRatio">
                    <currency-input v-model="form.shiyCompanyRatio" placeholder="请输入" :disabled="isDisable"></currency-input>
                </el-form-item>
                <el-form-item label="公积金基数" prop="housingFundBaseMoney">
                    <el-input v-model="form.housingFundBaseMoney" placeholder="请输入" :disabled="isDisable"></el-input>
                </el-form-item>
                <el-form-item label="公积金个人系数" prop="housingFundPersonRatio">
                    <currency-input v-model="form.housingFundPersonRatio" placeholder="请输入" :disabled="isDisable"></currency-input>
                </el-form-item>
                <el-form-item label="公积金公司系数" prop="housingFundCompanyRatio" :disabled="isDisable">
                    <currency-input v-model="form.housingFundCompanyRatio" placeholder="请输入" ></currency-input>
                </el-form-item>
            </el-form>
        </BoxCard>
...
export default {
        ...
        methods: {
            getSocialSecurity(d) {//获取基本信息 d是否校验
                // const self = this
                let isAll = false
